        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade w-100" data-ride="carousel" >
            <div class="carousel-inner">
                <div class="carousel-item">
                    <img src="{{asset('app-assets/images/slider/06.jpg')}}" class="img-fluid d-block w-100" alt="cf-img-1" style="height: 80vh">
                </div>
                <div class="carousel-item active">
                    <img src="{{asset('app-assets/images/slider/02.jpg')}}" class="img-fluid d-block w-100" alt="cf-img-2" style="height: 80vh">
                </div>
                <div class="carousel-item">
                    <img src="{{asset('app-assets/images/slider/05.jpg')}}" class="img-fluid d-block w-100" alt="cf-img-3" style="height: 80vh">
                </div>
            </div>
